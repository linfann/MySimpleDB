...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
        // some code goes here
        TupleDesc old = Database.getCatalog().getTupleDesc(tableid);
        List<TupleDesc.TDItem> descList = old.getDescList();
        List<TupleDesc.TDItem> newList = new ArrayList<>();
        String pre = tableAlias==null?"null.":tableAlias + ".";
        for (TupleDesc.TDItem tdItem : descList) {
            newList.add(new TupleDesc.TDItem(tdItem.fieldType, pre + tdItem.fieldName));
        }
